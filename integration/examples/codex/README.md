# AI_KV Integration — Codex Example

> This example shows how to configure OpenAI Codex (or similar coding agents) to use AI_KV.
...
# codex-config.yaml
tools:
  - name: aikv_capabilities
    command: aikv capabilities --output=json
    description: Check AI_KV available features
