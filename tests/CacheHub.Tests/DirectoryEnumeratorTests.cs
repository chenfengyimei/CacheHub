...
using EnumerationOptions = CacheHub.Indexing.Scanning.EnumerationOptions;
...
public class DirectoryEnumeratorTests
{
    ...
    private sealed class TempDir : IDisposable
    {
        ...
        public TempDir()
        {
            Path = System.IO.Path.Combine(System.IO.Path.GetTempPath(), "cachehub_enum_" + Guid.NewGuid().ToString("N"));
