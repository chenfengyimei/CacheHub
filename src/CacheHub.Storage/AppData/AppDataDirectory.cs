namespace CacheHub.Storage;

/// <summary>
/// Manages CacheHub application data directory structure.
/// All CacheHub data (config, index, cache, logs, temp) lives here, never in user source directories.
/// </summary>
public sealed class AppDataDirectory
{
    ...
    private static string GetDefaultRoot()
    {
        ...
        return Path.Combine(baseDir, "CacheHub");
    }
}
