...
[![Tests](https://img.shields.io/badge/Tests-993%20passed-brightgreen.svg)](#测试覆盖率)
...
│
├── tests/
│   └── CacheHub.Tests/             # 993 测试（单元 + 集成 + 安全 + Gate 回归 + Benchmark）
│
...
CacheHub 当前处于 **Pre-Alpha** 阶段。核心链路已通过 993 个测试验证，但不建议用于生产环境或处理敏感代码。
